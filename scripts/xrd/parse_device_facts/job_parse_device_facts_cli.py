...
"""
PyATS Job file for running Parse Device Facts CLI script
"""
...
def main(runtime):
    """
    Main job function that will run the Parse Device Facts CLI script
    """
    ...
    # Run the test script
    run(
        testscript='/Users/jeremierouzet/Documents/Dev/pyats/pyats-jeyws01/scripts/xrd/parse_device_facts/parse_device_facts_cli_jeylab.py',
        runtime=runtime,
        taskid='Parse_Device_Facts_CLI',
        testbed=testbed_file,
        description='Parse device facts via CLI'
    )
