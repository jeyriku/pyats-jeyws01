...
#
# Last Modified: 27.01.2026 19:42:22
...
def main():
    parser = argparse.ArgumentParser(description='Parse Device Facts NCC Script')
    parser.add_argument('--testbed',
                       default='../testbed/xrd/xrd_sw_tb_ncc_v1.0_clab.yaml',
