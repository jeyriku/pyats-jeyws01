...
"""
PyATS Job file for running Second Script v1.1
"""
...
def main(runtime):
    """
    Main job function that will run the Second Script v1.1
    """
    ...
    # Run the test script
    run(
        testscript='/Users/jeremierouzet/Documents/Dev/pyats/pyats-jeyws01/scripts/xrd/second_script/second_script_v1.1.py',
        runtime=runtime,
        taskid='Second_Script_v1.1',
        testbed=testbed_file,
        description='Run Second Script v1.1'
    )
